...
#     ### USER SEED DATA
#     User.create!(username: "Sean Martin", password: "Los Angeles", email: "sean@seanmartinstudio.com")
#     User.create!(username: "Charles Boyce", password: "Cambridge", email: "charles.boyce@gmail.com")
